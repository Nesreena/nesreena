        ...
        <FlexRow style={{ justifyContent: "start", alignItems: "flex-start" ,}}>
          ...
          <FlexColumn>
            <FlexRow style={{ justifyContent: "space-between"}}>
              <FlexColumn
                style={{ justifyContent: "start", alignItems: "flex-start", marginLeft:"10px"  }}
              >
                <Typography fontSize={32} fontWeight={"bold"} style={{margin:"10px 0  30px 0"}}>
                  {" "}
            ...
            <Typography style={{marginLeft:"10px" }}>{product.product?.description}</Typography>
          </FlexColumn>
        </FlexRow>
